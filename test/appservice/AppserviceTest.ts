...
describe('Appservice', () => {
    ...
    describe("thirdparty.protocol", () => {

        it("should handle thirdparty protocol requests", async () => {
            ...
            try {
                ...
                const result = await doCall("/_matrix/app/v1/thirdparty/protocol/fakeproto");
                expect(result).toEqual(responseObj);
                const result2 = await doCall("/_matrix/app/v1/thirdparty/protocol/anotherproto");
        ...
        it("should reject unknown protocols", async () => {
    ...
    describe("thirdparty.user.*", () => {
        it("should lookup a remote user by given fields", async () => {
            const { appservice, doCall } = await beginAppserviceWithProtocols(["fakeproto"]);
            ...
            const getUserSpy = simple.stub().callFn((protocol, fields, fn) => {
                expect(protocol).toEqual("fakeproto");
                expect(fields).toEqual(userFields);
                fn(responseObj);
            });
            appservice.on("thirdparty.user.remote", getUserSpy);
            try {
                const result = await doCall("/_matrix/app/v1/thirdparty/user/fakeproto", {}, userFields);
                expect(result).toEqual(responseObj);
            } finally {
                appservice.stop();
            }
        ...
        it("should lookup a matrix user by given fields", async () => {
            const { appservice, doCall } = await beginAppserviceWithProtocols(["fakeproto"]);
            const responseObj = ["user1", "user2"];
        ...
        it("should return 404 if no matrix users are found", async () => {
            const { appservice, doCall } = await beginAppserviceWithProtocols(["fakeproto"]);
            const expectedUserId = "@foobar:localhost";
            const getUserSpy = simple.stub().callFn((userid, fn) => {
                expect(userid).toEqual(expectedUserId);
        ...
        it("should return 404 if no remote users are found", async () => {
            const { appservice, doCall } = await beginAppserviceWithProtocols(["fakeproto"]);
            const userFields = {
                "foo": "bar",
                "bar": "baz"
            ...
            appservice.on("thirdparty.user.remote", getUserSpy);
            try {
                await doCall("/_matrix/app/v1/thirdparty/user/fakeproto", {}, userFields);
            } catch (e) {
                expect(e.error).toMatchObject({
                    errcode: "NO_MAPPING_FOUND",
                    error: "No mappings found"
    ...
    describe("thirdparty.location.*", () => {
        it("should lookup a remote location by given fields", async () => {
            ...
            try {
                const result = await doCall("/_matrix/app/v1/thirdparty/location/fakeproto", {}, locationFields);
                expect(result).toEqual(responseObj);
            } finally {
                appservice.stop();
            }
        ...
        it("should return 404 if no remote location are found", async () => {
            ...
            appservice.on("thirdparty.location.remote", getLocationSpy);
            try {
                await doCall("/_matrix/app/v1/thirdparty/location/fakeproto", {}, locationFields);
            } catch (e) {
                expect(e.error).toMatchObject({
                    errcode: "NO_MAPPING_FOUND",
                    error: "No mappings found"
